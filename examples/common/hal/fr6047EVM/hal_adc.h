...
/*! Enable/Disable ADC functionality */
#define ENABLE_ADC
...
//*****************************************************************************
//
//! Initialize ADC for temperature sensor and supply measurements
//!
//! \return none
//
// *****************************************************************************
...
//*****************************************************************************
//
//! Get temperature in Celsius from internal sensor
//!
//! \return temperature in Celsius degrees
//
// *****************************************************************************
extern float hal_adc_tempsensor_readCelsius(void);
...
//!
//! \return voltage of VCC supply in millivolts
//
// *****************************************************************************
extern uint16_t hal_adc_voltagesupply_readmV(void);
