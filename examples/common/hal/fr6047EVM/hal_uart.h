...
//! \file   hal_uart.h
//!
//! \brief  Hardware Abstraction Layer for Serial (UART) communication
//!
...
//*****************************************************************************
//
//! Initialize UART used for communication with PC
//!
//! Initializes GPIOs and USCI module
//!
//! \return none
//
// *****************************************************************************
...
//*****************************************************************************
//
//! Transmit a byte through UART
//!
//! Transmits a byte to UART, doesn't return until the TX buffer is empty
//! Note that this implementation uses polling for simplicity purposes.
//!
...
//
// *****************************************************************************
extern void hal_uart_TxByte(uint8_t Data);
extern void _TxString(uint8_t *Data);
extern bool Send_SendATCommands();
extern bool Send_NewData(float dt);
extern bool is_ready_for_new_data(void);
//*****************************************************************************
//
//! Checks if there is a byte in the RX buffer.
//!
//! This function doesn't need Interrupt mode. The USCI can receive a "wake-up"
//! byte which is checked when the application is out of a critical section.
//!
//! \param byte Pointer to the received byte (if return is true)
//!
//! \return true if a byte was received, false if not
//
// *****************************************************************************
extern bool hal_uart_RxPeekByte(uint8_t *byte);

//*****************************************************************************
//
//! Enable Reception using Interrupts
//!
//! \return none
//
// *****************************************************************************
extern void hal_uart_RxEnableIntMode(void);

//*****************************************************************************
//
//! Disable Reception using Interrupts
//!
//! \return none
//
// *****************************************************************************
extern void hal_uart_RxDisableIntMode(void);
