...
//! \file   hal_lcd.c
//!
//! \brief  Hardware Abstraction Layer for FH-1138P Segmented LCD
//!
...
const uint8_t symbolTable[][2] =
{
    ...
    {0x04, LCD_C_SEGMENT_LINE_20},   /* HAL_LCD_SYMBOL_DEGREES */
    {0x01, LCD_C_SEGMENT_LINE_26},   /* HAL_LCD_SYMBOL_WARNING (not available)*/
    {0x02, LCD_C_SEGMENT_LINE_26},   /* HAL_LCD_SYMBOL_TM (not available)*/
    {0x04, LCD_C_SEGMENT_LINE_26},   /* HAL_LCD_SYMBOL_HEART (not available)*/
    {0x08, LCD_C_SEGMENT_LINE_26},   /* HAL_LCD_SYMBOL_CLOCK (not available)*/
    {0x01, LCD_C_SEGMENT_LINE_24},   /* HAL_LCD_SYMBOL_WIRELESS_RX */
    {0x04, LCD_C_SEGMENT_LINE_24},   /* HAL_LCD_SYMBOL_WIRELESS_TX */
    {0x01, LCD_C_SEGMENT_LINE_27},   /* HAL_LCD_SYMBOL_BATTERY_TIP */
    {0x01, LCD_C_SEGMENT_LINE_28},   /* HAL_LCD_SYMBOL_BATTERY_CASE */
    {0x02, LCD_C_SEGMENT_LINE_28},   /* HAL_LCD_SYMBOL_BATTERY_1 */
    {0x02, LCD_C_SEGMENT_LINE_27},   /* HAL_LCD_SYMBOL_BATTERY_2 */
    {0x04, LCD_C_SEGMENT_LINE_28},   /* HAL_LCD_SYMBOL_BATTERY_3 */
    {0x04, LCD_C_SEGMENT_LINE_27},   /* HAL_LCD_SYMBOL_BATTERY_4 */
    {0x08, LCD_C_SEGMENT_LINE_28},   /* HAL_LCD_SYMBOL_BATTERY_5 */
    {0x08, LCD_C_SEGMENT_LINE_27},   /* HAL_LCD_SYMBOL_BATTERY_6 */
};
...
void hal_lcd_Init(void)
{
    ...
    */
    ...
    GPIO_setAsPeripheralModuleFunctionInputPin(
        GPIO_PORT_P6,
        GPIO_PIN4 | GPIO_PIN5 | GPIO_PIN6 |GPIO_PIN1 | GPIO_PIN2 | GPIO_PIN3,
    ...
    LCD_C_setPinAsLCDFunctionEx(LCD_C_BASE, LCD_C_SEGMENT_LINE_18,
...
//*****************************************************************************
//
//! Update LCD segment memory from local LCD Memory map
//!
//! \param baseposition Segment to start copying
//! \param num_segments Number of segments to copy
//!
//! \return none
//
// *****************************************************************************
