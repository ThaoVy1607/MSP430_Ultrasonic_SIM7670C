...
#ifndef TESTINGDC_TESTING_H_
#define TESTINGDC_TESTING_H_
...
// Function Prototypes
//
//! \brief Called before a measurement
//!
//! This function can be used to configure device before a measurement
//!
//! \return none
extern void Testing_PreMeasurement_Update(void);

//! \brief Function called after a measurement
//!
//! This function can be used to configure device after a measurement.
//!
//! \return none
extern void Testing_PostMeasurement_Update(void);

//! \brief Function called after algorithms are executed
//!
//! This function can be used to configure device after algorithms
//!
//! \return none
extern void Testing_PostAlgorithm_Update(void);

//! \brief Function called before sending results to GUI
//!
//! \param results Pointer to results structure. Optionally updated in function
//!
//! \return none
extern bool Testing_Update_Results(USS_Algorithms_Results *results, float *debugData);

//! \brief Function called after receiving new config from GUI and before
//!         reconfiguring USS
//!
//!  This function can be used to reconfigure USS parameters after GUI sends
//!     an update
//!
//! \return none
extern void Testing_GUIUpdate_PreUSSConfig(void);

//! \brief Function called after receiving new config from GUI after reconfiguring
//!         USS
//!
//!  This function can be used to reconfigure registers after the USS was reconfigured
//!     by the GUI
//!
//! \return none
extern void Testing_GUIUpdate_PostUSSConfig(void);

#endif /* TESTINGDC_TESTING_H_ */
