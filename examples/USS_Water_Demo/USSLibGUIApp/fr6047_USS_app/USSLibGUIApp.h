...
#ifndef _USSLIBGUIAPP_H_
#define _USSLIBGUIAPP_H_


extern USS_Algorithms_Results algRes;

/*** FUNCTIONS ***/

//! \brief This routine will Initialize the USS Library at the start of the
//!         GUI example and on reset
//!
//! \return USS_message_code Error code
extern USS_message_code USSLibGUIApp_Init(void);

//! \brief Re-initializes the USS peripheral, algorithms and application
//!
//! \return USS_message_code Error code
extern USS_message_code USSLibGUIApp_ReInitialize(void);

//! \brief Main Engine for the Application running on the MSP430FR604x
//!        for the Command Center GUI.
//!
//! This routine will send an error message to the GUI if there was a
//! failure in the initialization.
//!
//! \return none
extern void USSLibGUIApp_Engine(void);


//! \brief Sends an error message
//!
//! \param error_type   Error type (check COMMAND_HANDLER_ERROR_FATAL_xxx definitions)
//! \param error_code   16-bit error code send for complementary information
//!
//! \return none
extern void USSLibGUIApp_send_error(uint16_t error_type, uint16_t error_code);


#endif /* _USSLIBGUIAPP_H_ */
